		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ZHOUI5 Customer Application",
									"targetURL": "#atclouddnatraining00zhoui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"atclouddnatraining00zhoui5-display": {
								"semanticObject": "atclouddnatraining00zhoui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=at.clouddna.training00.zhoui5",
									"url": sap.ui.require.toUrl("at/clouddna/training00/zhoui5")
								}
							}
						}
					}
